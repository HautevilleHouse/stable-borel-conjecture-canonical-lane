...
mkdir -p .tmp/stable_borel_conjecture
cp artifacts/stitch_constants.json .tmp/stable_borel_conjecture/stitch_constants.json
cp artifacts/constants_registry.json .tmp/stable_borel_conjecture/constants_registry.json
