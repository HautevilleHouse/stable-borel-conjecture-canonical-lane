...
Canonical Lane research workspace for a flagship problem in geometric topology and rigidity theory:
proving stable topological rigidity of aspherical manifolds through an admissible surgery-assembly closure architecture.

## Main Manuscript

- [paper/STABLE_BOREL_CONJECTURE_PREPRINT.md](paper/STABLE_BOREL_CONJECTURE_PREPRINT.md)
- [paper/CANONICAL_ROUTING_INDEX.md](paper/CANONICAL_ROUTING_INDEX.md)

## Structure

- `paper/`
  - `STABLE_BOREL_CONJECTURE_PREPRINT.md`
...
1. Theorem chain first: read `paper/STABLE_BOREL_CONJECTURE_PREPRINT.md`.
...
Current SBOR runner policy:

- `repro/run_repro.sh` extracts, promotes, runs `scripts/sbor_closure_guard.py`, updates `repro/repro_manifest.json`, and enforces `fully_extracted` release-gate mode.
...
3. artifact key consumed by `scripts/sbor_closure_guard.py`.
...
- Manuscript target: [paper/STABLE_BOREL_CONJECTURE_PREPRINT.md](paper/STABLE_BOREL_CONJECTURE_PREPRINT.md)
