# Constant Extraction Spec (SBOR)
    ...
    ## Formula Set
    - `kappa_rigidity_raw = c_rigidity_raw * rigidity_density_raw - e_rigidity_raw`
- `sigma_surgery_raw = surgery_floor_raw - assembly_loss_raw - restart_loss_raw`
...
- `sigma_star_can_raw = sigma_star_can_raw`
    ...
    ## Validations
    - positivity required for: `kappa_rigidity`, `sigma_surgery`, `kappa_compact`, `rho_rigidity`, `homeomorphism_transfer`, `sigma_star_can`
    ...
    3. `scripts/sbor_closure_guard.py`
